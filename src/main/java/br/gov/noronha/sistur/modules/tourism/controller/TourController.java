...
import br.gov.noronha.sistur.modules.tourism.service.TourService;
...
public class TourController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<TourDTO>> getById(@PathVariable Long id, Authentication authentication) {
        TourDTO tour = tourService.findById(id, authentication);
